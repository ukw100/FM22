...
class HTTP_Common
{
    public:
        ...
        static void             print_function_list (String name, uint_fast16_t selected_f, bool do_display);
        static void             print_function_list (uint_fast16_t loco_or_common_idx, bool is_loco, String name, uint_fast16_t selected_fidx, bool do_display);
        ...
        static const char *     get_location (uint_fast16_t loco_idx);
        ...
        static void             print_railroad_group_list (String name, uint_fast8_t rrgidx, bool do_display);
